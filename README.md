...
- **Vanilla JavaScript:** Powers interactive scripts linked to layout enhancements.

## 📁 File Structure
```text
├── index.html                   # Main HTML structure
├── script.js                    # Core logic and interactivity script
├── README.md                    # Project documentation
├── image.jpeg                   # Image asset
├── image.png                    # Image asset
└── LENDERS POV DATA.pdf         # Attached data resource
```

## 🚀 Getting Started

To view this locally, clone the repository and open the HTML file.
